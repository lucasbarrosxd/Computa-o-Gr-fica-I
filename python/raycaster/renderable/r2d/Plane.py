...
from python.raycaster.renderable import auxi
...
class Plane:
    ...
    @staticmethod
    def intersection(plane: "Plane", line: Line, coef: bool = True, fwrd: bool = True) -> Union[None, Point, float]:
        v = line.direction
        n = plane.normal
